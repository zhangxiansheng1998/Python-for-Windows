...
class TestCase(unittest.TestCase):
    ...
    @unittest.skip('unittest不执行这条测试用例')
    def test2_homepage(self):
        """下载homepage图片"""
        self.homepage.get_picture()
    ...
    @unittest.skip('unittest不执行这条测试用例')
    def test5_institution(self):
        """修改筛查机构信息"""
        self.insmanagement.enter_into_institution_management()
        self.insmanagement.institution_operations()
